...
public:
  ...
  void init();
  std::vector<point> read(bool waitToRead = false , bool readAll = true); // 1パケのデータを取得
protected:
...
constexpr uint8_t CrcTable[256] = { // CRC用のテーブル https://storage.googleapis.com/mauser-public-images/prod_description_document/2021/315/8fcea7f5d479f4f4b71316d80b77ff45_096-6212_a.pdf
